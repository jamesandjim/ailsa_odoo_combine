...
class HmrcSendWizard(models.TransientModel):
    ...
    def default_get(self, fields_list):
        ...
        date_from = self.env.context['options']['date']['date_from']
        date_to = self.env.context['options']['date']['date_to']
    ...
    hmrc_cash_basis = fields.Boolean('Cash Accounting Scheme', readonly=True, store=False, default=lambda self: self.env.context['options']['cash_basis'])
